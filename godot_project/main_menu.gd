...
@onready var kacamata1_button: Button = $ButtonContainer/ButtonKacamata1
@onready var kacamata2_button: Button = $ButtonContainer/ButtonKacamata2
@onready var kacamata3_button: Button = $ButtonContainer/ButtonKacamata3
@onready var kacamata4_button: Button = $ButtonContainer/ButtonKacamata4
@onready var tentangKami_button: Button = $ButtonContainer/ButtonTentangKami
@onready var quit_button: Button = $ButtonContainer/ButtonQuit
...
func _on_button_tentang_kami_pressed() -> void:
	get_tree().change_scene_to_file("res://tentang_kami.tscn")
